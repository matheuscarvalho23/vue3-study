...
import { validateEmptyAndLenghtThree, validateEmptyAndEmail } from "../../utils/validators";
  ...
  setup() {
    ...
    async function handleSubmit() {
      try {
        ...
        if (errors.status === 401) toast.error("E-mail ou senha inválidas");
        if (errors.status === 400) toast.error("Ocorreu um erro ao realizar o login");
